...
console.log(fahrToCels(35));//1.66666666666666
...
//console.log(isSuit("hearts"));//true
//console.log(isSuit("HEARTS"));//true
...
console.log(isRank("jack"));//true
console.log(isRank("Queen"));//true
...
console.log(isCard("one","club"));//false
...
console.log(isCapitalized("ANUSHA"));//true
console.log(isCapitalized("anusha"));//false
...
console.log(getHTMLText("<p>this is some text in a paragraph</p>"));
...
console.log(isHTMLElement("<p>this is a paragraph</p>"));//true
console.log(isHTMLElement("this is a tweet!"));